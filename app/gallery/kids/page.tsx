...
import type { GalleryFilters, GalleryItem, GalleryRailsResponse } from '@/lib/types/database';

const KIDS_FILTERS: GalleryFilters = {
  search: '',
  type: 'storylines',
  genre: 'all',
  ageGroup: 'all',
    ...
    <main className="relative min-h-dvh bg-neutral-950 font-sans text-neutral-200 selection:bg-emerald-500/30">
      ...
      <div className="pb-[calc(4rem+var(--safe-bottom))]">
        ...
        <div className="mx-auto mt-16 max-w-7xl px-4 lg:px-8">
          <h2 className="mb-6 font-serif text-xl text-neutral-200 md:text-2xl">All Kids Stories</h2>
